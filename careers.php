...
<html>
	<head>
		<?php
		$page_title = 'careers.php';
		$pgDesc = 'careers Page';
		$keyWords = 'xsysys careers';
		include ('head.php');
		?>
		<script>
	...
	<body>
		<div id="main-aboubus" class="main">
			...
			?>
			<article>
				<section id="careers-main-section" class="main-section">
					<div class="xsysys-content-block" id="xsysys-content-block">
						<section>
							...
							<div class="silver-bg">
								...
								<div id="job_op_block" class="job_op_block" style="display:none;">
								...
								<script>
									...
									function showJobOpBlock(id) {
										$('#'+id).closest('#careers_desc_block').css({'display':'none'});
										$('#'+id).closest('#careers_desc_block').siblings('#job_op_block').css({'display':'block'});
									}
								</script>
							</div>
