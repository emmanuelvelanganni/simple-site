								...
								<script>
									function showEvent(id) {
										...
										if($(id).attr('id') == "in_news_id1") {
											...
											$('#in_news_id2').closest('li').attr({'style':'list-style-image:url(images/xsysys-ui/links/bullet1.png)!important;color:#999999;'});
											$('#in_news_id1').closest('li').attr({'style':'list-style-image:url(images/xsysys-ui/links/bullet1_hover.png)!important;color:#999999;'});
										}
										else {
											$('#in_news1').css({'display':'none'});
											$('#in_news2').css({'display':'block'});
											$('#in_news_id1').closest('li').attr({'style':'list-style-image:url(images/xsysys-ui/links/bullet1.png)!important;color:#999999;'});
											$('#in_news_id2').closest('li').attr({'style':'list-style-image:url(images/xsysys-ui/links/bullet1_hover.png)!important!;color:#999999;'});
										}
									}
								</script>
